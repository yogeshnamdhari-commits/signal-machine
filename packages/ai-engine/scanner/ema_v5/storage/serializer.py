    ...
    def serialize_signal(cls, signal: Dict[str, Any]) -> Dict[str, Any]:
        ...
        return {
            ...
            "ema_data": {
                ...
                "ema144": ema.get("ema144", 0),
                "ema200": ema.get("ema200", 0),
                "ema_chain_pattern": ema.get("ema_chain_pattern", ""),
                "ema_cross_price": ema.get("ema_cross_price", 0),
                "ema_cross_time": ema.get("ema_cross_time", 0),
                "bars_since_chain": ema.get("bars_since_chain", 0),
                "ema_distance_atr": ema.get("ema_distance_atr", 0),
                "ema20_x_50": ema.get("ema20_x_50", 0),
                "ema50_x_144": ema.get("ema50_x_144", 0),
                "ema144_x_200": ema.get("ema144_x_200", 0),
            },
            "htf_data": signal.get("htf_data", {}),
            "atr_expanding": signal.get("atr_expanding", True),
            "volume_normalized": signal.get("volume_normalized", 0),
