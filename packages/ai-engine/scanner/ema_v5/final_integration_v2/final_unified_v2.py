"""
EMA_V5 Final Unified v2 — Unified interface for all EMA_V5 capabilities.
...
class EMAv5FinalUnifiedV2:
    """Unified interface for all EMA_V5 capabilities."""

    VERSION = "1.0.0"

    def __init__(self) -> None:
        self._orchestrator = EMAv5FinalOrchestratorV2()
    ...
    def get_health(self) -> Dict[str, Any]:
        """Get system health."""
        hc = self._orchestrator.get_module("health_check")
        return hc.check_all()
...
# Singleton instance
_instance: Optional[EMAv5FinalUnifiedV2] = None


def get_instance() -> EMAv5FinalUnifiedV2:
    """Get the singleton instance."""
    global _instance
    if _instance is None:
        _instance = EMAv5FinalUnifiedV2()
    return _instance
